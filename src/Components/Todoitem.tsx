...
const TodoItem = ({
  ...
  return (
    <div
      className={`flex items-center justify-between gap-6 bg-white shadow py-2 px-6 rounded-2xl dark:bg-gray-800 dark:text-white${
    ...
    >
      ...
      <label
        ...
        htmlFor={todo.id}
      >
        <Check className="stroke-black dark:stroke-white stroke-4" />
      </label>
